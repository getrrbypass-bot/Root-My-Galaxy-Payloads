...
/* SM-A736B / A736BXXSCGZF1 / kernel 5.4.289-qgki-32200428-abA736BXXSCGZF1 */

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/a73xqxx/a73xq:16/BP2A.250605.031.A3/A736BXXSCGZF1:user/release-keys"
#endif

#define TARGET_MODEL          "SM-A736B"
#define TARGET_BUILD          "A736BXXSCGZF1"
#define TARGET_KERNEL_RELEASE \
    "5.4.289-qgki-32200428-abA736BXXSCGZF1"
...
#define CALL_USERMODEHELPER_EXEC_WORK_OFF  0x08335a08ULL
#define NOOP_LLSEEK_OFF                    0x0855a480ULL
#define COPY_SPLICE_READ_OFF               0x085a3f0cULL
#define CONFIGFS_READ_ITER_OFF             0x08622cbcULL
#define CONFIGFS_BIN_WRITE_ITER_OFF        0x086231b4ULL
#define ASHMEM_IOCTL_OFF                   0x081f4674ULL
#define ASHMEM_COMPAT_IOCTL_OFF            0x081f4f94ULL
#define ASHMEM_MMAP_OFF                    0x081f4fe8ULL
#define ASHMEM_OPEN_OFF                    0x081f518cULL
#define ASHMEM_RELEASE_OFF                 0x081f5204ULL
#define ASHMEM_SHOW_FDINFO_OFF             0x081f5320ULL
#define ANON_PIPE_BUF_OPS_OFF             0x0a5b2e38ULL
#define ASHMEM_FOPS_OFF                    0x0a58a568ULL
#define KMALLOC_CACHES_OFF                 0x0a6d6350ULL
#define SYSTEM_UNBOUND_WQ_OFF              0x0ad4fac8ULL
#define INIT_TASK_OFF                      0x0ae43e80ULL
#define ROOT_TASK_GROUP_OFF                0x0b06cde0ULL
#define ASHMEM_MISC_OFF                    0x0add5420ULL
#define SELINUX_ENFORCING_OFF              0x0b058000ULL
#define SLIDE_NFULNL_LOGGER_NAME_OFF       0x0a595de0ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF     0x0ad4ac18ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0aeb39d0ULL
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0834ef7cULL
...
/* ---- P0 physical memory (SM8325 / Snapdragon 778G) ---- */
#define P0_PAGE_OFFSET       0xffffff8000000000ULL
#define P0_PHYS_OFFSET       0x80000000ULL
#define P0_KERNEL_PHYS_LOAD  0xa8000000ULL

/* ---- sysctl boot_id ---- */
#define SYSCTL_BOOTID_OFF  0x0b2a9de1ULL
...
/* ---- rt_mutex_waiter aliases (compact layout) ---- */
#define FAKE_WAITER_PRIO_OFF      FAKE_WAITER_TREE_PRIO_OFF
#define FAKE_WAITER_DEADLINE_OFF  FAKE_WAITER_TREE_DEADLINE_OFF

/* ---- Build label ---- */
#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "a73x-A736BXXSCGZF1-app"
#else
#define BUILD_VARIANT_LABEL "a73x-A736BXXSCGZF1-root-umh"
#endif
